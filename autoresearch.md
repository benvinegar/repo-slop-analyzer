...
- Refinement win: skipping giant bundled/generated files over **5k logical lines** improved the honest full-set score from **0.967** to **0.977** by removing Hyper's vendored `yarn-standalone.js` noise without hurting the AI cohort.
